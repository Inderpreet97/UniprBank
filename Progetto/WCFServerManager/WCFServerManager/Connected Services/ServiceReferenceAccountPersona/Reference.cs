...
namespace WCFServerManager.ServiceReferenceAccountPersona {
    ...
    public interface IServiceAccountPersona {
        ...
        WCFServerManager.ServiceReferenceAccountPersona.Persona[] GetListaPersone(string tipoAccount, string idFiliale);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAccountPersona/GetListaPersone", ReplyAction="http://tempuri.org/IServiceAccountPersona/GetListaPersoneResponse")]
        System.Threading.Tasks.Task<WCFServerManager.ServiceReferenceAccountPersona.Persona[]> GetListaPersoneAsync(string tipoAccount, string idFiliale);
        ...
        WCFServerManager.ServiceReferenceAccountPersona.Persona CheckUsername(string username);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAccountPersona/CheckUsername", ReplyAction="http://tempuri.org/IServiceAccountPersona/CheckUsernameResponse")]
        System.Threading.Tasks.Task<WCFServerManager.ServiceReferenceAccountPersona.Persona> CheckUsernameAsync(string username);
        ...
        WCFServerManager.ServiceReferenceAccountPersona.Persona GetPersona(string codiceFiscale);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAccountPersona/GetPersona", ReplyAction="http://tempuri.org/IServiceAccountPersona/GetPersonaResponse")]
        System.Threading.Tasks.Task<WCFServerManager.ServiceReferenceAccountPersona.Persona> GetPersonaAsync(string codiceFiscale);
        ...
        bool AggiungiPersona(WCFServerManager.ServiceReferenceAccountPersona.Persona persona, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAccountPersona/AggiungiPersona", ReplyAction="http://tempuri.org/IServiceAccountPersona/AggiungiPersonaResponse")]
        System.Threading.Tasks.Task<bool> AggiungiPersonaAsync(WCFServerManager.ServiceReferenceAccountPersona.Persona persona, string password);
        ...
        bool ModificaPersona(string username, WCFServerManager.ServiceReferenceAccountPersona.Persona persona);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAccountPersona/ModificaPersona", ReplyAction="http://tempuri.org/IServiceAccountPersona/ModificaPersonaResponse")]
        System.Threading.Tasks.Task<bool> ModificaPersonaAsync(string username, WCFServerManager.ServiceReferenceAccountPersona.Persona persona);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceAccountPersonaChannel : WCFServerManager.ServiceReferenceAccountPersona.IServiceAccountPersona, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceAccountPersonaClient : System.ServiceModel.ClientBase<WCFServerManager.ServiceReferenceAccountPersona.IServiceAccountPersona>, WCFServerManager.ServiceReferenceAccountPersona.IServiceAccountPersona {
        ...
        public WCFServerManager.ServiceReferenceAccountPersona.Persona[] GetListaPersone(string tipoAccount, string idFiliale) {
            return base.Channel.GetListaPersone(tipoAccount, idFiliale);
        }
        
        public System.Threading.Tasks.Task<WCFServerManager.ServiceReferenceAccountPersona.Persona[]> GetListaPersoneAsync(string tipoAccount, string idFiliale) {
        ...
        public WCFServerManager.ServiceReferenceAccountPersona.Persona CheckUsername(string username) {
            return base.Channel.CheckUsername(username);
        }
        
        public System.Threading.Tasks.Task<WCFServerManager.ServiceReferenceAccountPersona.Persona> CheckUsernameAsync(string username) {
            return base.Channel.CheckUsernameAsync(username);
        }
        
        public WCFServerManager.ServiceReferenceAccountPersona.Persona GetPersona(string codiceFiscale) {
            return base.Channel.GetPersona(codiceFiscale);
        }
        
        public System.Threading.Tasks.Task<WCFServerManager.ServiceReferenceAccountPersona.Persona> GetPersonaAsync(string codiceFiscale) {
            return base.Channel.GetPersonaAsync(codiceFiscale);
        }
        
        public bool AggiungiPersona(WCFServerManager.ServiceReferenceAccountPersona.Persona persona, string password) {
            return base.Channel.AggiungiPersona(persona, password);
        }
        
        public System.Threading.Tasks.Task<bool> AggiungiPersonaAsync(WCFServerManager.ServiceReferenceAccountPersona.Persona persona, string password) {
            return base.Channel.AggiungiPersonaAsync(persona, password);
        }
        
        public bool ModificaPersona(string username, WCFServerManager.ServiceReferenceAccountPersona.Persona persona) {
            return base.Channel.ModificaPersona(username, persona);
        }
        
        public System.Threading.Tasks.Task<bool> ModificaPersonaAsync(string username, WCFServerManager.ServiceReferenceAccountPersona.Persona persona) {
